...
func (x *FeedRes) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_FeedRes[number], err)
}

func (x *FeedRes) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	var v BaseResp
	offset, err = fastpb.ReadMessage(buf, _type, &v)
	if err != nil {
		return offset, err
...
func (x *FeedRes) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	var v Video
	offset, err = fastpb.ReadMessage(buf, _type, &v)
	if err != nil {
		return offset, err
...
func (x *FeedRes) fastReadField3(buf []byte, _type int8) (offset int, err error) {
...
func (x *FeedRes) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *FeedRes) fastWriteField1(buf []byte) (offset int) {
	if x.BaseResp == nil {
		return offset
	}
...
func (x *FeedRes) fastWriteField2(buf []byte) (offset int) {
	if x.VideoList == nil {
		return offset
	}
...
func (x *FeedRes) fastWriteField3(buf []byte) (offset int) {
	if x.NextTime == 0 {
		return offset
	}
...
func (x *FeedRes) sizeField1() (n int) {
	if x.BaseResp == nil {
		return n
	}
...
func (x *FeedRes) sizeField2() (n int) {
	if x.VideoList == nil {
		return n
	}
	for i := range x.VideoList {
...
func (x *FeedRes) sizeField3() (n int) {
	if x.NextTime == 0 {
		return n
	}
...
var fieldIDToName_FeedRes = map[int32]string{
	1: "BaseResp",
	2: "VideoList",
	3: "NextTime",
}

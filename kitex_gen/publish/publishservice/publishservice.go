...
func publishHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(publish.PublishReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(publish.PublishService).Publish(ctx, req)
		if err != nil {
			return err
		}
	...
	case *PublishArgs:
		success, err := handler.(publish.PublishService).Publish(ctx, s.Req)
		if err != nil {
			return err
		}
...
var PublishArgs_Req_DEFAULT *publish.PublishReq

func (p *PublishArgs) GetReq() *publish.PublishReq {
	if !p.IsSetReq() {
...
type PublishResult struct {
	Success *publish.PublishRes
}

var PublishResult_Success_DEFAULT *publish.PublishRes

func (p *PublishResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(publish.PublishRes)
	}
...
func (p *PublishResult) GetSuccess() *publish.PublishRes {
	if !p.IsSetSuccess() {
...
func (p *PublishResult) SetSuccess(x interface{}) {
	p.Success = x.(*publish.PublishRes)
}
...
func publishListHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(publish.PublishListReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
...
func (p *PublishListArgs) Unmarshal(in []byte) error {
	msg := new(publish.PublishListReq)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var PublishListArgs_Req_DEFAULT *publish.PublishListReq

func (p *PublishListArgs) GetReq() *publish.PublishListReq {
	if !p.IsSetReq() {
...
type PublishListResult struct {
	Success *publish.PublishListRes
}

var PublishListResult_Success_DEFAULT *publish.PublishListRes

func (p *PublishListResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(publish.PublishListRes)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *PublishListResult) Unmarshal(in []byte) error {
	msg := new(publish.PublishListRes)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *PublishListResult) GetSuccess() *publish.PublishListRes {
	if !p.IsSetSuccess() {
...
func (p *PublishListResult) SetSuccess(x interface{}) {
	p.Success = x.(*publish.PublishListRes)
}
...
func (p *kClient) Publish(ctx context.Context, Req *publish.PublishReq) (r *publish.PublishRes, err error) {
...
func (p *kClient) PublishList(ctx context.Context, Req *publish.PublishListReq) (r *publish.PublishListRes, err error) {
